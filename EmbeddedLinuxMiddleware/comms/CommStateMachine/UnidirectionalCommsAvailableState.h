#ifndef UNIIDIRECTIONALCOMMSAVAILABLESTATE_H_
#define UNIIDIRECTIONALCOMMSAVAILABLESTATE_H_
...
namespace CecilStLabs
{
    ...
    */
   class UnidirectionalCommsAvailableState : public State, public ILoggable
   {
      public:
         /**
          ...
          * 
          * @param https The secure session used for communication
          *
          * @param parser The parser of the responses that are returned from the server.
          */
         UnidirectionalCommsAvailableState(CommDAL* commDAL,
          ...
          */
         virtual ~UnidirectionalCommsAvailableState();
      ...
      protected:
         ...
         /**
          * indicate whether to just do one request before returning back to websocket?
          * TODO: 
          */
         bool m_single;
   };
